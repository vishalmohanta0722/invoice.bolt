...
import { Mail, Lock, ArrowRight, Chrome, AlertCircle, User } from 'lucide-react';
...
export function SignUp({ onSignUpSuccess, onNavigateToSignIn }: SignUpProps) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-600">Join us to start invoicing</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">Already have an account? <button onClick={onNavigateToSignIn} className="text-gray-900 font-semibold hover:underline">Sign in</button></p>
          </div>
        </div>
      </div>
    </div>
